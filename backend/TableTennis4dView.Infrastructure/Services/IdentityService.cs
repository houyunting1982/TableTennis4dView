...
using TableTennis4dView.Application.Common.Exceptions;
...
namespace TableTennis4dView.Infrastructure.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager, IPlayerQueryRepository playerQueryRepository)
        {
        ...
        public async Task<bool> UpdateUserPlayer(string id, long playerId)
        {
            var player = await _playerQueryRepository.GetByIdAsync(playerId);
            var user = await _userManager.FindByIdAsync(id);
            if (player != null && !user.Players.Contains(player)) {
